...
import com.bhishma.ams.authentication.config.JwtService;
import com.bhishma.ams.authentication.token.Token;
import com.bhishma.ams.authentication.token.TokenRepository;
import com.bhishma.ams.authentication.token.TokenType;
...
//if already register
  ...
  public void refreshToken(
    ...
    if (userEmail != null) {
      var user = this.repository.findByUserId(userEmail)
              .orElseThrow();
